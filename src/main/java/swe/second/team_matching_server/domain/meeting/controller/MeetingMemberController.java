...
public class MeetingMemberController {
    ...
    public ApiResponse<MeetingMembers> getMembers(
    ...
    public ApiResponse<String> application(
    ...
    public ApiResponse<MeetingMembers> acceptApplication(
        @PathVariable Long meetingId, @RequestBody MeetingMemberTargetDto targetDto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMembers> rejectApplication(
        @PathVariable Long meetingId, @RequestBody MeetingMemberTargetDto dto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMembers> upgradeToCoLeader(
        @PathVariable Long meetingId, @RequestBody MeetingMemberTargetDto dto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMembers> downgradeToMember(
        @PathVariable Long meetingId, @RequestBody MeetingMemberTargetDto dto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMembers> leave(
        @PathVariable Long meetingId, @RequestBody MeetingMemberTargetDto dto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMemberRole> getMyRole(
        @PathVariable Long meetingId, @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
    ...
    public ApiResponse<MeetingMembers> updateRole(
        @PathVariable Long meetingId, @RequestBody MeetingMemberUpdateDto dto,
        @AuthenticationPrincipal UserDetails userDetails) {
        String userId = userDetails.getUsername();
