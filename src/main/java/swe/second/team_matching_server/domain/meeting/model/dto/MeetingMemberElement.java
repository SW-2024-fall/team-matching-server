...
public class MeetingMemberElement extends UserElement {
    ...
    public MeetingMemberElement(Long id, String name, String profileUrl, int attendenceScore, Major major, String studentId, String phoneNumber, List<String> features, MeetingMemberRole role) {
