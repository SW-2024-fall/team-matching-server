...
public class MeetingInvalidMeetingTypeException extends IllegalArgumentException {
    public MeetingInvalidMeetingTypeException() {
        super(ResultCode.MEETING_INVALID_MEETING_TYPE);
    }
}
